...
if(NOT WIN32)
    ...
    find_library( STEPCODE_SDAI_AP203_LIB
        NAMES libsdai_ap203.so libsdai_ap203-static.a sdai_ap203 sdai_ap203-static
        HINTS ${STEPCODE_SEARCH_HINTS}
        PATH_SUFFIXES lib
    )
    find_library( STEPCODE_EDITOR_LIB
        NAMES libstepeditor.so libstepeditor-static.a stepeditor stepeditor-static
        HINTS ${STEPCODE_SEARCH_HINTS}
        PATH_SUFFIXES lib
    )
    find_library( STEPCODE_CORE_LIB
        NAMES libstepcore.so libstepcore-static.a stepcore stepcore-static
        HINTS ${STEPCODE_SEARCH_HINTS}
        PATH_SUFFIXES lib
    )
    find_library( STEPCODE_DAI_LIB
        NAMES libstepdai.so libstepdai-static.a stepdai stepdai-static
        HINTS ${STEPCODE_SEARCH_HINTS}
        PATH_SUFFIXES lib
    )
    find_library( STEPCODE_UTILS_LIB
        NAMES libsteputils.so libsteputils-static.a steputils steputils-static
        HINTS ${STEPCODE_SEARCH_HINTS}
        PATH_SUFFIXES lib
    )
